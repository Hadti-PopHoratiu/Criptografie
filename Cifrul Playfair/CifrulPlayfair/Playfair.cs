...
namespace CifrulPlayfair
{
    class Playfair
    {
        ...
        public static char[,] CreateMatrix(string prop)
        {
        ...
        public static void ShowMatrix(char[,] theM)
        {
            for (int i = 0; i < theM.GetLength(0); i++)
            {
                for (int j = 0; j < theM.GetLength(1); j++)
        ...
        static void Encription(int vIndex, char[,] m)
        {
        ...
        static void Decription(int vIndex, char[,] m)
        {
            int i1 = 0, j1 = 0, i2 = 0, j2 = 0;
            for (int i = 0; i < m.GetLength(0); i++)
            {
        ...
        static void DeleteChar(char uW = 'X')
        {
